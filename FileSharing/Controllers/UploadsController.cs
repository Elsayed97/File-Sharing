...
namespace FileSharingApp.Controllers
{
    ...
    public class UploadsController : Controller
    {
        ...
        public async Task<IActionResult> Create(InputFile model)
        {
            ...
            TempData["ConfirmDelete"] = localizer["ConfirmDeleteMessage"]?.Value; 
            TempData["DeleteBtn"] = localizer["DeleteBtn"]?.Value;
            TempData["BackToList"] = localizer["BackToList"]?.Value;
            return View(model);
        }
        ...
        public async Task<IActionResult> DeleteConfirmation(string id)
        {
            ...
            var fileName = selectedUpload.FileName;
